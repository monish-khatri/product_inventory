        ...
        class Product {
            ...
            public function addProduct($productname, $price, $availablequantity, $category, $image) {
                ...
                if ($result) {
                    ...
                    $sql1 = "INSERT INTO product_changed_log(type,prev,current,pid,deleted) VALUES('Price','-'," . $price . "," . $lastid . ",'0')";
                    $result1 = $this->conn->query($sql1);
                    $sql2 = "INSERT INTO product_changed_log(type,prev,current,pid,deleted) VALUES('Quantity','-'," . $availablequantity . "," . $lastid . ",'0')";
                    $result2 = $this->conn->query($sql2);
                }
            }
            ...
            public function addSale($salesprice, $soldquantities, $pid) {
                ...
                while ($row = mysqli_fetch_assoc($result1)) {
                    ...
                    if ($row['available_quantity'] >= $soldquantities) {
                        ...
                        if ($result) {
                            $lastid = $this->conn->insert_id;
                            $sql3 = "INSERT INTO sale_changed_log(type,prev,current,sid,deleted) VALUES('Sale Price','-'," . $salesprice . "," . $lastid . ",'0')";
                            $result3 = $this->conn->query($sql3);
                            $sql4 = "INSERT INTO sale_changed_log(type,prev,current,sid,deleted) VALUES('Sold Quantity','-'," . $soldquantities . "," . $lastid . ",'0')";
